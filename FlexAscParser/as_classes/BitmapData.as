public class BitmapData extends Object
{
	...
	public function draw(source : IBitmapDrawable, matrix : Matrix) : void;

	public function draw(source : IBitmapDrawable, matrix : Matrix, colorTransform : ColorTransform) : void;

	public function draw(source : IBitmapDrawable, matrix : Matrix, colorTransform : ColorTransform, blendMode : String) : void;

	public function draw(source : IBitmapDrawable, matrix : Matrix, colorTransform : ColorTransform, blendMode : String, clipRect : Rectangle) : void;

	public function draw(source : IBitmapDrawable, matrix : Matrix, colorTransform : ColorTransform, blendMode : String, clipRect : Rectangle, smoothing : Boolean) : void;
	...
	public function getColorBoundsRect(mask : uint, color : uint) : Rectangle;

	public function getColorBoundsRect(mask : uint, color : uint, findColor : Boolean) : Rectangle;
